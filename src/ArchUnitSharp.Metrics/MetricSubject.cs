...
/// <see cref="ClassInfo"/> — the <c>method count</c> and <c>field count</c> metrics and any custom
/// metric — and a file-level metric measures one extracted <see cref="FileInfo"/> — the
/// <c>lines of code</c>, <c>statements</c>, <c>imports</c>, <c>classes</c> and <c>interfaces</c>
/// metrics.
/// </summary>
